...
/***/ function(module, exports, __webpack_require__) {
	...
	var lazer_beam_1 = __webpack_require__(20);
	...
	function step() {
	    ...
	    _.each(world.beams, function (beam) {
	        if (!beam.ui) {
	            beam.ui = new lazer_beam_1.default(beam);
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var World = (function () {
	    function World(players, width, height, asteroids) {
	        this.box = new bounding_box_1.BoundingBox(new point_1.Point(0, 0), new point_1.Point(width, height));
	        this.ships = [];
	        this.asteroids = [];
	        this.beams = [];
	        this.uis = [];
	        ...
	        for (var i = 0; i < players; i++) {
	            var ship = this.addShip(new point_1.Point(window.innerWidth + _.random(-window.innerWidth, window.innerWidth) / 5, window.innerHeight + _.random(-window.innerHeight, window.innerHeight) / 5));
	    ...
	    World.prototype.step = function () {
	        ...
	        _.each(this.ships, function (thing) {
	            thing.step();
	        });
	        /*	asteroids
	        ------------------------------------------*/
	        ...
	        _.each(self.asteroids, function (asteroid) {
	            _.each(self.beams, function (beam) {
	                var distance = point_1.Point.distance(asteroid.p, beam.p);
	        ...
	        _.each(self.asteroids, function (asteroid) {
	            _.each(self.ships, function (ship) {
	                var distance = point_1.Point.distance(asteroid.p, ship.p);
	    ...
	    World.prototype.addShip = function (position) {
	        this.ships.push(new ship_1.Ship(this, position));
	        return _.last(this.ships);
	    };
	    World.prototype.addAsteroid = function (position, pos_momentum, size) {
	        this.asteroids.push(new asteroid_1.Asteroid(this, position, pos_momentum, size));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ship = (function (_super) {
	    ...
	    function Ship(world, position) {
	        var _this = _super.call(this, world, new point_1.Point(position.x, position.y), new vector_1.Vector(0, 0)) || this;
	    ...
	    Ship.prototype.step = function () {
	        ...
	        /*	Thrust
	        ------------------------------------------*/
	        var thrust_vector = rotation_1.Rotation.getNormalizedVector(this.r);
	        thrust_vector.multiply(this.thrust * 0.03);
	        this.pm.add(thrust_vector);
	        /*	Reverse Thrust
	        ------------------------------------------*/
	        var reverse_thrust_vector = rotation_1.Rotation.getNormalizedVector(this.r);
	...
	Ship.gamepad_handler = {
	    strafe: function (ship) {
	        ...
	        ship.r = new vector_1.Vector(ship.bound_gamepad.right_x, ship.bound_gamepad.right_y).angle() + 180;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vector = (function (_super) {
	    ...
	    function Vector(x, y) {
	        ...
	        Vector.not = new point_1.Point(0, 0);
	        return _this;
	    }
	    ...
	    Vector.prototype.rotate = function (degrees) {
	        var new_angle = rotation_1.Rotation.getNormalizedVector(degrees + this.angle() + 180); // why +180 again?? why?1?
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Point = (function () {
	    ...
	    Point.prototype.moveToward = function (p, s) {
	        ...
	        if (d > 0) {
	            var r = s / d, dx = p.x - this.x, dy = p.y - this.y, v = new vector_1.Vector(dx * r, dy * r);
	            this.add(v);
	        }
	        else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Asteroid = (function (_super) {
	    ...
	    Asteroid.prototype.breakOrDie = function () {
	        if (this.size > 20) {
	            var v1 = new vector_1.Vector(this.pm.x, this.pm.y);
	            v1.rotate(10);
	            this.world.addAsteroid(new point_1.Point(this.p.x, this.p.y), v1, this.size / 2);
	            var v2 = new vector_1.Vector(this.pm.x, this.pm.y);
	            v2.rotate(-10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sprite_1 = __webpack_require__(12);
	var rotation_1 = __webpack_require__(8);
	var LazerBeamUI = (function (_super) {
	    __extends(LazerBeamUI, _super);
	    function LazerBeamUI(lazer) {
	        var _this = _super.call(this, lazer.p, new rotation_1.Rotation(lazer.r), 0.02, './images/lazer-beam-sprite.png', 512, 1408, 1, 11) || this;
	        _this.lazer = lazer;
	        return _this;
	    }
	    LazerBeamUI.prototype.updateAndRender = function (ctx) {
	        //this.scale = 1;
